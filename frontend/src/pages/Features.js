  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white py-16">
      <div className="container mx-auto px-4">
        ...
        >
          {features.map((feature) => (
            <motion.div 
              ...
              className="bg-gray-800 rounded-xl overflow-hidden border border-gray-700 shadow-lg flex flex-col h-full"
            >
              ...
              <div className="p-6 pt-0">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className={`px-4 py-2 rounded-lg bg-gradient-to-r ${feature.color} text-white w-full font-medium`}
                >
                  Learn More
                </motion.button>
              </div>
        ...
        {/* Call to Action */}
        <motion.div 
          className="bg-gradient-to-r from-indigo-900 to-purple-900 rounded-2xl p-8 md:p-12 relative overflow-hidden shadow-2xl"
